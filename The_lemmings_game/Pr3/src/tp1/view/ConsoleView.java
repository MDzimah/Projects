...
public class ConsoleView extends GameView {
	...
	private String endMessage() {
		...
		else if (game.playerLooses()) sb.append(Messages.PLAYER_LOSES);
	...
	@Override
	public void showErrorWithoutLineSeparator(String message) {
        System.out.println(Messages.ERROR_WITHOUT_LINE_SEPARATOR.formatted(message));		
	}
