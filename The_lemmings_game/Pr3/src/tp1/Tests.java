...
public class Tests {
	...
	public static final String FILE_PREFIXES[] = {
			...
			, /*test 1*/ "01_1-command"
			, /*test 2*/ "01_2-play"
			, /*test 3*/ "01_3-newRoles"
			, /*test 4*/ "01_4-newRoles_errors"
			, /*test 5*/ "02_1-newRoles"
			, /*test 6*/ "01_5-newRoles_conf_0"
			, /*test 7*/ "01_6-file_errors"
			, /*test 8*/ "01_7-file_reset"
			, /*test 9*/ "02_2-reset_load_save"
			};
